...
/**
 * Bitmap implementation of the LTL "next" operator. 
 */
public class BitmapX extends UnaryBitmapProcessor
{
  public BitmapX(Type type)
  {
    super(type);
  }
  ...
  {
    return bitmap.clone().removeFirstBit();
  }
}
