...
/**
 * Bitmap implementation of the LTL "globally" operator. 
 */
public class BitmapG extends UnaryBitmapProcessor
{
  public BitmapG(Type type)
  {
    super(type);
  }
  ...
  protected BitmapAdapter processBitmap(BitmapAdapter bitmap)
  {
    ...
    BitmapAdapter newBm = LTLBitmap.createAdapter(type);
